import { LibraryRegistrationInput, NewLibrary } from "../types/comicLibrary.type.ts";
import { createComicLibrary } from "../repositories/comicLibraries.repo.ts";

export function registerComicLibrary(libraryData: LibraryRegistrationInput): number {

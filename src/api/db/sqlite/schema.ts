...
export const comicBookInkersTable = sqliteTable("comic_book_inkers", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_inker_id: int().notNull().references(() => comicInkersTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const comicBookColoristsTable = sqliteTable("comic_book_colorists", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_colorist_id: int().notNull().references(() => comicColoristsTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const comicBookLetterersTable = sqliteTable("comic_book_letterers", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_letterer_id: int().notNull().references(() => comicLetterersTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const comicBookEditorsTable = sqliteTable("comic_book_editors", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_editor_id: int().notNull().references(() => comicEditorsTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});

export const comicBookCoverArtistsTable = sqliteTable("comic_book_cover_artists", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_cover_artist_id: int().notNull().references(() => comicCoverArtistsTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const comicBookPublishersTable = sqliteTable("comic_book_publishers", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_publisher_id: int().notNull().references(() => comicPublishersTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const comicBookImprintsTable = sqliteTable("comic_book_imprints", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_imprint_id: int().notNull().references(() => comicImprintsTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const comicBookGenresTable = sqliteTable("comic_book_genres", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_genre_id: int().notNull().references(() => comicGenresTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const comicBookCharactersTable = sqliteTable("comic_book_characters", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_character_id: int().notNull().references(() => comicCharactersTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const comicBookLocationsTable = sqliteTable("comic_book_locations", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_location_id: int().notNull().references(() => comicLocationsTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const comicBookTeamsTable = sqliteTable("comic_book_teams", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_team_id: int().notNull().references(() => comicTeamsTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const comicBookStoryArcsTable = sqliteTable("comic_book_story_arcs", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_story_arc_id: int().notNull().references(() => comicStoryArcsTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});

export const comicBookSeriesGroupsTable = sqliteTable("comic_book_series_groups", {
	id: int().primaryKey({ autoIncrement: true }),
	comic_book_id: int().notNull().references(() => comicBooksTable.id, { onDelete: "cascade" }),
	comic_series_group_id: int().notNull().references(() => comicSeriesGroupsTable.id, { onDelete: "cascade" }),
	created_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
	updated_at: text().notNull().default(sql`CURRENT_TIMESTAMP`),
});	
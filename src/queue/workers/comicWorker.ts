...
import { ComicMetadata } from "../../api/interfaces/ComicMetadata.interface.ts";
...
import { insertComicBook } from "../../api/repositories/comicBooks.repo.ts";
import { insertComicSeries, getComicSeriesByPath } from "../../api/repositories/comicSeries.repo.ts";

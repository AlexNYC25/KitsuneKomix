...
import { comicBookQueue, seriesQueue } from "#app/queues.ts";

import { getComicSeriesByPath, insertComicSeries, insertComicSeriesIntoLibrary } from "#db/sqlite/models/comicSeries.model.ts";
 ...
 * @returns 
 */
export const processComicSeries = async (job: WorkerFileJob) => {
 ...
 */
export const processAddingANewComicSeries = async (job: WorkerFileJob) => {

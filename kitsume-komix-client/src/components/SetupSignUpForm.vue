...
<template>
	<div class="rounded-lg bg-slate-900 shadow-lg p-8">
		...
		<form @submit="signupFormSubmit" class="space-y-4">
			...
			<!-- Email Field -->
			<div>
				<label for="signup-email" class="block text-sm font-medium text-text-primary mb-1">Email</label>
				<input
					id="signup-email"
					v-model="email"
					type="email"
			...
			<!-- Password Field -->
			<div>
				<label for="signup-password" class="block text-sm font-medium text-text-primary mb-1">Password</label>
				<input
					id="signup-password"
					v-model="password"
					type="password"
			...
			<div>
				...
				<input
					...
					class="w-full px-3 py-2 bg-surface-overlay border rounded-md text-text-primary placeholder-text-muted focus:outline-none focus:ring-1 transition-colors duration-200"
					:class="confirmPasswordAttrs.error ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-surface-overlay focus:border-brand focus:ring-brand'"
				/>
			...
			<button
				...
				class="w-full px-4 py-2 my-2 bg-brand hover:brightness-110 disabled:opacity-50 text-text-primary font-medium rounded-md transition-colors duration-200"
			>
